...
public class MainController extends HttpServlet {
    ...
    private final String SHOPPINGCONTROLLER ="AddItemController";
    private final String VIEWCONTROLLER = "ShoppingView.jsp";
    private final String CREATECONTROLLER ="CreateController";
    private final String DELETECARTITEMCONTROLLER = "DeleteCartItemController";
    /**
